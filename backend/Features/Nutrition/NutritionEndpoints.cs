...
namespace HealthyLifeApp.API.Features.Nutrition;
...
public static class NutritionEndpoints
{
    public static void MapNutritionEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/profile", async (NutritionProfileRequest request, AppDbContext db, ClaimsPrincipal user) =>
        {
        ...
        group.MapGet("/suggestions", async (string bloodType, AppDbContext db) =>
        {
